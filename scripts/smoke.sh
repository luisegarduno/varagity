#!/usr/bin/env bash
# Smoke-test the Phase-2 infrastructure: healthchecks, llama.cpp, infinity,
# and the postgres schema. Run after `docker compose up -d --wait`:
#
...
echo "[1/4] Service health states"
for svc in llamacpp infinity-embeddings postgres; do
